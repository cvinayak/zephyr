...
#define LL_FEAT_BIT_SYNC_TRANSFER_SENDER BIT64(BT_LE_FEAT_BIT_PAST_SEND)
#else /* !CONFIG_BT_CTLR_SYNC_TRANSFER_SENDER */
#define LL_FEAT_BIT_SYNC_TRANSFER_SENDER 0
#endif /* !CONFIG_BT_CTLR_SYNC_TRANSFER_SENDER */

#if defined(CONFIG_BT_CTLR_SYNC_TRANSFER_RECEIVER)
#define LL_FEAT_BIT_SYNC_TRANSFER_RECEIVER BIT64(BT_LE_FEAT_BIT_PAST_RECV)
#else /* !CONFIG_BT_CTLR_SYNC_TRANSFER_RECEIVER */
#define LL_FEAT_BIT_SYNC_TRANSFER_RECEIVER 0
...
#define LL_FEAT_BIT_CHANNEL_SOUNDING BIT64(BT_LE_FEAT_BIT_CHANNEL_SOUNDING)
#else /* !CONFIG_BT_CTLR_CHANNEL_SOUNDING */
#define LL_FEAT_BIT_CHANNEL_SOUNDING 0
...
/* Channel Sounding (Host Support) bit is controlled by host */
#if defined(CONFIG_BT_CTLR_CHANNEL_SOUNDING)
#define LL_FEAT_HOST_BITS_CHANNEL_SOUNDING BIT64(BT_LE_FEAT_BIT_CHANNEL_SOUNDING_HOST)
#else /* !CONFIG_BT_CTLR_CHANNEL_SOUNDING */
#define LL_FEAT_HOST_BITS_CHANNEL_SOUNDING 0U
#endif /* !CONFIG_BT_CTLR_CHANNEL_SOUNDING */
...
#define LL_FEAT_HOST_BIT_MASK  (LL_FEAT_HOST_BITS_ISO_CHANNELS | \
				...
				LL_FEAT_HOST_BITS_CHANNEL_SOUNDING)

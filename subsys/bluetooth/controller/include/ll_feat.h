...
#define LL_FEAT_BIT_PAWR_ADVERTISER BIT64(BT_LE_FEAT_BIT_PAWR_ADVERTISER)
#else /* !CONFIG_BT_CTLR_ADV_PERIODIC_RSP */
#define LL_FEAT_BIT_PAWR_ADVERTISER 0
#endif /* !CONFIG_BT_CTLR_ADV_PERIODIC_RSP */

#if defined(CONFIG_BT_CTLR_SYNC_PERIODIC_RSP)
#define LL_FEAT_BIT_PAWR_SCANNER BIT64(BT_LE_FEAT_BIT_PAWR_SCANNER)
#else /* !CONFIG_BT_CTLR_SYNC_PERIODIC_RSP */
#define LL_FEAT_BIT_PAWR_SCANNER 0
...
#define LL_FEAT                  (LL_FEAT_BIT_ENC | \
				  ...
				  LL_FEAT_BIT_PAWR_ADVERTISER | \
				  LL_FEAT_BIT_PAWR_SCANNER | \

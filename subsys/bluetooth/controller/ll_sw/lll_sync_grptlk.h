...
int lll_sync_grptlk_init(void);
void lll_sync_grptlk_create_prepare(void *param);
void lll_sync_grptlk_prepare(void *param);
void lll_sync_grptlk_flush(uint8_t handle, struct lll_sync_iso *lll);

extern uint8_t ull_sync_grptlk_lll_index_get(struct lll_sync_iso *lll);
extern struct lll_sync_iso_stream *ull_sync_grptlk_lll_stream_get(uint16_t handle);

...
#define EVENT_OVERHEAD_RESUME_US      62
#elif defined(CONFIG_SOC_COMPATIBLE_NRF52X)
#define EVENT_OVERHEAD_START_US       367 /* 12 RTC ticks equivalent */
#define EVENT_OVERHEAD_RESUME_US      123
#else /* nRF53x Series */
#define EVENT_OVERHEAD_START_US       397 /* 13 RTC ticks */
#define EVENT_OVERHEAD_RESUME_US      153
#endif

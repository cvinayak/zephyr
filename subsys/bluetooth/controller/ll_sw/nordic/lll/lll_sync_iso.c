...
static LLL_ISR_CODE_RAM_ATTR void isr_rx_estab(void *param);
static LLL_ISR_CODE_RAM_ATTR void isr_rx(void *param);
static LLL_ISR_CODE_RAM_ATTR void isr_rx_done(void *param);
...
static LLL_ISR_CODE_RAM_ATTR void isr_rx_iso_data_valid(const struct lll_sync_iso *const lll,
				  uint16_t handle, struct node_rx_pdu *node_rx);
static LLL_ISR_CODE_RAM_ATTR void isr_rx_iso_data_invalid(const struct lll_sync_iso *const lll,
				    uint16_t latency, uint8_t bn,
				    uint16_t handle,
				    struct node_rx_pdu *node_rx);
static LLL_ISR_CODE_RAM_ATTR void isr_rx_ctrl_recv(struct lll_sync_iso *lll, struct pdu_bis *pdu);

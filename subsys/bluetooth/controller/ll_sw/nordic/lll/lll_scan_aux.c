...
static LLL_ISR_CODE_RAM_ATTR void isr_rx_ull_schedule(void *param);
static LLL_ISR_CODE_RAM_ATTR void isr_rx_lll_schedule(void *param);
static LLL_ISR_CODE_RAM_ATTR void isr_rx(struct lll_scan *lll, struct lll_scan_aux *lll_aux,
		   uint8_t phy_aux);
static int isr_rx_pdu(struct lll_scan *lll, struct lll_scan_aux *lll_aux,
		      ...
		      uint8_t rssi_ready);
static LLL_ISR_CODE_RAM_ATTR void isr_tx_scan_req_ull_schedule(void *param);
static LLL_ISR_CODE_RAM_ATTR void isr_tx_scan_req_lll_schedule(void *param);
#if defined(CONFIG_BT_CENTRAL)
static LLL_ISR_CODE_RAM_ATTR void isr_tx_connect_req(void *param);
static LLL_ISR_CODE_RAM_ATTR void isr_rx_connect_rsp(void *param);
...
static LLL_ISR_CODE_RAM_ATTR void isr_tx(struct lll_scan_aux *lll_aux, void (*isr)(void *), void *param)
{

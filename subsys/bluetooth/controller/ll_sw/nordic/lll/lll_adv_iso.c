...
static BT_CTLR_LLL_ISR_CODE_RAM_ATTR void isr_tx_create(void *param);
static BT_CTLR_LLL_ISR_CODE_RAM_ATTR void isr_tx_normal(void *param);
static BT_CTLR_LLL_ISR_CODE_RAM_ATTR void isr_tx_common(void *param,
...
static BT_CTLR_LLL_ISR_CODE_RAM_ATTR void isr_done_create(void *param);
static BT_CTLR_LLL_ISR_CODE_RAM_ATTR void isr_done_term(void *param);

...
simulation_id="${BOARD_TS}_connected_iso_legacy_adv_acl_first_sequential"
verbosity_level=2
EXECUTE_TIMEOUT=200

cd ${BSIM_OUT_PATH}/bin

Execute ./bs_${BOARD_TS}_tests_bsim_bluetooth_ll_cis_prj_conf_overlay-legacy_adv_acl_first_sequential_conf \
